...
void jit_uni_lrn_fwd_kernel_t<sse41, data_type::f32>::generate(
    ...
    if (compute_tail) {
        this->pslldq(xc_lo, l_shift * static_cast<int>(sizeof(float)));
    ...
    if (compute_tail) {
        this->pslldq(xd_lo, l_shift * static_cast<int>(sizeof(float)));
    ...
    if (compute_tail) {
        this->pslldq(xe_lo, l_shift * static_cast<int>(sizeof(float)));
